        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              ...
              <select
                className={`block appearance-none w-full bg-white-200 border ${errors.specialization ? 'border-red-500' : 'border-gray-200'} text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white`}
              ...
              {errors.specialization && <div className="text-red-500">{errors.specialization?.message}</div>}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative mt-3">
              <input
                className={`block appearance-none w-full bg-white-200 border ${errors.cvFile ? 'border-red-500' : 'border-gray-200'} text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white`}
              ...
              {errors.cvFile && <div className="text-red-500">{errors.cvFile?.message}</div>}
            </div>
          </div>
