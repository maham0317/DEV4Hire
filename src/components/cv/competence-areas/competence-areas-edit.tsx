...
const CompetenceAreasEdit: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  return (
    <div className="bg-white p-10 rounded shadow">
      <h2 className="text-2xl font-bold">Edit Competence Areas</h2>
      <p className="mt-3 text-[#332c55]">Main competence areas give us an overview regarding your experience and help in match your needs with job opportunities.</p>
