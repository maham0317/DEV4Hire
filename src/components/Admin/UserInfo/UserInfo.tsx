...
const UserProfile = () => {
  return (
    ...
    <div className="max-w-lg mx-auto bg-white shadow-lg rounded-lg px-12 py-6 mt-5">
      ...
      <div className="mb-4">
        <label className="block text-gray-600 text-sm font-semibold mb-2" htmlFor="contact">
          Contact
        </label>
        <p className="text-gray-900 text-sm">
          Phone: <a href="tel:+123456789" className="text-blue-600">123-456-789</a>
          <br />
          Email: <a href="mailto:jane@example.com" className="text-blue-600">jane@example.com</a>
        </p>
      </div>
      <div className="flex">
