...
const CompetenceAreasWizard: React.FC = () => {
  const { t } = useTranslation();

  return (
    <div className="bg-gray-100 p-12 rounded">
    <div className="bg-white p-10 rounded shadow text-0.75rem">
      <h2 className="text-2xl font-bold text-[#1f0f32]">Main competence areas</h2>
      <p className="mt-3 text-[#332c55]">
        Select your main competence areas to help us find the best match for you among our clients.
      </p>
...
export default CompetenceAreasWizard;
