...
import { useWorkRoleEdit } from "./work-role-edit-hook";
        ...
        <div className="fixed inset-0 overflow-y-auto z-50 flex justify-center items-center">
          ...
          <div className="relative bg-white  shadow-lg">
                ...
                <div className="relative">
                  <input
                    ...
                    {...register("WorkRoleName", {
                      required: t(
                        "WorkRole.AddOrEdit.Input.ValidationError.Required"
                      ),
                      maxLength: {
                        value: 25,
                        message: t(
                          "WorkRole.AddOrEdit.Input.ValidationError.NameMaxLength",
            ...
            <div className="flex justify-end  p-3 md:p-5 border-t font-montserrat font-semibol rounded-b dark:border-gray-600">
              ...
              >
                {isLoading
                  ? t("WorkRole.AddOrEdit.Input.Button.saving")
